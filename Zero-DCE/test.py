...
parser.add_argument('--lowlight_test_images_path', type=str, default="test/images/") #modify this
config = parser.parse_args()

def test(lowlight_test_images_path):
    # Check if enhanced directory exists
    directory = "test/enhanced"
    ...
    for test_file in glob.glob(lowlight_test_images_path + "*.png"):
        ...
        enhance_image.save(test_file.replace("images", "enhanced"))
        #nhance_image.save("/enhanced/")
