...
if __name__ == '__main__':
  #Path to the times.txt in KITTI dataset
	ground_time = np.loadtxt('/home/yash/Datasets/KITTI/dataset/sequences/07/times.txt')
  ...
  #Path to the ground truth file
	ground_data = np.loadtxt('/home/yash/Datasets/KITTI/dataset/poses/07.txt')
	...
	# print(trans_error)
	plt.axis('equal')
	a = plt.scatter(ground_points[0], ground_points[2], s=5, c='blue')
	b = plt.scatter(list(re_fpoints[0]), list(re_fpoints[2]), s=5, c='red')
	plt.legend((a, b), ('ground truth', 'estimated'), markerscale=5, fontsize=22)
